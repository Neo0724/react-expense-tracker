...
export default function Dashboard() {
    ...
    const style = {
        color: getBalance(totalExpensesAmount, totalIncomeAmount) < 0 ? "red" : "green",
    };
    ...
    return (
        ...
        <Chart income={income} expenses={expenses} dashboardMonth={dashboardMonth} dashboardYear={dashboardYear} />
